...
export const allSettings: Record<SettingsTabKey, SettingCategory[]> = {
  usersAndPayroll: [
    ...
    },
    {
      ...
      description:
        'Configure pay periods, payroll cycles, and processing calendars.',
    ...
    },
    {
      ...
      description:
        'Configure technician time tracking, attendance, and time-card policies.',
  ...
  operations: [
    ...
    },
    {
      ...
      description:
        'Configure booking workflow, work-order defaults, and behavior.',
    ...
    },
    {
      ...
      description:
        'Define recommendation statuses used across service workflows.',
  ...
  sales: [
    {
      title: 'Lead',
      description:
        'Configure lead sources, statuses, and qualification defaults.',
    ...
    },
    {
      ...
      description:
        'Configure estimate numbering, terms, templates, and options.',
  ...
  serviceAgreements: [
    ...
    },
    {
      ...
      description:
        'Manage services, assets, and coverage included in templates.',
  ...
  assetsAndInventory: [
    {
      title: 'Asset Setup',
      description:
        'Configure asset types, attributes, manufacturers, and defaults.',
    ...
    },
    {
      ...
      description:
        'Configure inventory settings, units, defaults, and behavior.',
  ...
  system: [
    {
      ...
      description:
        'Create reusable email and SMS templates with system variables.',
