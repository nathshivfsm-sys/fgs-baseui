...
### Code health
Three co-equal signals: code health 8.04/10 avg (Good), hotspot health 6.08/10 (improving), worst `libs/ui/src/components/ui/select/select.tsx` at 2.05/10 · maintainability 8.6/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `libs/ui/src/icons/icons.stories.tsx` — untested hotspot — impact −2.0
