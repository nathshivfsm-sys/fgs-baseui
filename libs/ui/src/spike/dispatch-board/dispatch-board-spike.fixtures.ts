...
export const SPIKE_SCHEDULED: readonly SpikeWorkOrder[] = [
  ...
  },
  {
    ...
    customer: 'Redwood Cafe',
    street: '268 Redwood Ave',
    trade: 'HVAC',
    priority: 'Low',
    estimatedMinutes: 60,
  ...
  },
  {
    id: 'WO-1176',
    title: 'Maintenance',
    customer: 'Dogwood Library',
    street: '159 Dogwood St',
    trade: 'HVAC',
    priority: 'Medium',
    estimatedMinutes: 120,
    technicianId: 't-emily',
  ...
  },
  {
    id: 'WO-1177',
    title: 'Duct Cleaning',
    customer: 'Ironwood Studio',
    street: '147 Ironwood Ct',
    trade: 'HVAC',
    priority: 'Medium',
    estimatedMinutes: 120,
    technicianId: 't-emily',
  ...
  },
  {
    ...
    customer: 'Magnolia Works',
    street: '369 Magnolia Ave',
    trade: 'Plumbing',
    priority: 'High',
    estimatedMinutes: 180,
  ...
  },
  {
    id: 'WO-1166',
    title: 'System Check',
    customer: 'Hickory Motors',
    street: '852 Hickory Ln',
    trade: 'Plumbing',
    priority: 'Medium',
    estimatedMinutes: 120,
    technicianId: 't-james',
  ...
  },
  {
    id: 'WO-1152',
    title: 'Calibration',
    customer: 'Willows Plant',
    street: '456 Willows St',
    trade: 'Electrical',
    priority: 'Low',
    estimatedMinutes: 120,
    technicianId: 't-sarah',
...
export const SPIKE_UNASSIGNED: readonly SpikeWorkOrder[] = [
  {
    ...
    priority: 'High',
    estimatedMinutes: 120,
    requestedWindow: 'Today, 10:00 AM',
    technicianId: null,
    start: null,
    end: null,
  },
  {
    ...
    street: '456 Oak Ave, Chicago',
    trade: 'Plumbing',
    priority: 'Medium',
    estimatedMinutes: 90,
    requestedWindow: 'Today, 2:00 PM',
    technicianId: null,
    start: null,
    end: null,
  },
  {
    ...
    street: '789 Pine Rd, Northside',
    trade: 'Electrical',
    priority: 'Medium',
    estimatedMinutes: 60,
    requestedWindow: 'Tomorrow, 1:00 PM',
    technicianId: null,
    start: null,
    end: null,
  },
  {
    ...
    street: '321 Elm St, Eastside',
    trade: 'HVAC',
    priority: 'Low',
    estimatedMinutes: 180,
    requestedWindow: 'Tomorrow, 9:00 AM',
    technicianId: null,
    start: null,
    end: null,
  },
