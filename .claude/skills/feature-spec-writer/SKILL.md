...
- If the request is only adding swagger catalog endpoints (contract DTOs, data-access factories, MSW, integration tests — no screen), use `catalog-endpoint-spec-writer` instead of this skill.
