...
- `apps/settings/src/App.tsx` — 2 bug fixes, last fix 2 days ago; 17 commits/90d
- `apps/settings/src/App.stories.tsx` — 2 bug fixes, last fix 5 days ago; 20 commits/90d
...
### Code health
Three co-equal signals: code health 7.88/10 avg (Good), hotspot health 5.76/10 (stable), worst `libs/ui/src/components/ui/select/select.tsx` at 2.05/10 · maintainability 8.6/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
