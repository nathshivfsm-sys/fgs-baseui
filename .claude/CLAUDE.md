...
- `apps/settings/src/App.stories.tsx` — 2 bug fixes, last fix 4 days ago; 20 commits/90d
...
### Code health
Three co-equal signals: code health 7.99/10 avg (Good), hotspot health 6.03/10 (stable), worst `libs/ui/src/components/ui/select/select.tsx` at 2.05/10 · maintainability 8.6/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `apps/settings/src/App.tsx` — hidden coupling — impact −2.0
