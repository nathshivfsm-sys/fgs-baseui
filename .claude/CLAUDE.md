...
### Code health
Three co-equal signals: code health 7.7/10 avg (Good), hotspot health 5.44/10 (stable), worst `apps/settings/src/App.stories.tsx` at 1.0/10 · maintainability 8.57/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
