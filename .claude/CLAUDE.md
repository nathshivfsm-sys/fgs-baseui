...
### Code health
Three co-equal signals: code health 7.72/10 avg (Good), hotspot health 5.52/10 (stable), worst `apps/settings/src/App.stories.tsx` at 1.0/10 · maintainability 8.56/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `.storybook/aliases.ts` — change entropy — impact −2.4
