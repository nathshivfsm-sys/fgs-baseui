...
## Codebase Intelligence for orbit-mfe (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-22 (commit 3e8ad11). Confidence: 100%.Scope: standard index · template content · full Git · 157 eligible file pages omitted. Missing or unavailable evidence is not a negative finding. Run `repowise update --full` to continue the model-backed upgrade (cost is previewed before generation).Machine-readable scope: `{"analysis": {"skipped": [], "unavailable": []}, "content_provenance": "template", "file_pages": {"configured_cap": null, "effective_cap": null, "eligible": 674, "generated": 517, "omitted": 157}, "git_commit_cap": 500, "git_history_coverage": {"complete_through_depth": 105, "deep_commits": 0, "deep_files": 0, "eligible_files": 682, "fallback_files": 0, "files_with_history": 682, "global_commits": 105, "per_file_limit": 500, "recent_files": 682, "retained_commits": 1330, "unavailable_files": 0, "workers": 8}, "git_tier": "full", "provider": {"embedder": "mock", "model": null, "model_cost_possible": false, "name": null, "reused": false}, "run_mode": "standard", "search": {"full_text": "available", "next_command": "repowise reindex", "semantic": "unavailable"}, "upgrade": {"completed_stages": [], "next_stage": "generation", "retryable": true, "status": "pending"}, "version": 1}`
...
### Architecture
**Files:** 806 | **Lines:** 39756 | **Monorepo:** 8 packages | **Import cycles:** 1
orbit-mfe is a multi-package typescript codebase of 806 files, split across 8 packages. Execution starts at .storybook/main.ts, apps/invoice/src/App.tsx, apps/invoice/src/bootstrap.tsx and 10 other entry points. ---
...
- `libs/ui/src/components` — libs/ui/src/components · libs/ui/src/components/ui/tooltip · libs/ui/src/components/ui/typography ·…
...
- `apps/settings/src/App.stories.tsx` — 2 bug fixes, last fix 2 days ago; 19 commits/90d
- `apps/settings/src/pages/CompanySettingsPage/CompanySettingsPage.tsx` — 1 bug fix, last fix 2 days ago; 4 commits/90d
- `apps/settings/src/pages/BusinessUnitPage/component/GlBreakTablePanel.tsx` — 1 bug fix, last fix 2 days ago; 3 commits/90d
- `tools/integration/src/custom-fetch.integration.test.ts` — 1 bug fix, last fix 2 days ago; 4 commits/90d
- `apps/settings/src/pages/ZonePostalCodePage/component/ZonePostalCodeHeader.tsx` — 1 bug fix, last fix 2 days ago; 4 commits/90d

### Code health
Three co-equal signals: code health 7.75/10 avg (Good), hotspot health 5.53/10 (stable), worst `apps/settings/src/App.stories.tsx` at 1.0/10 · maintainability 8.57/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
