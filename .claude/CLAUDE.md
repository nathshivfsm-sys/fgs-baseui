...
- `apps/settings/src/App.stories.tsx` — 2 bug fixes, last fix 3 days ago; 19 commits/90d
- `apps/settings/src/pages/CompanySettingsPage/CompanySettingsPage.tsx` — 1 bug fix, last fix 3 days ago; 4 commits/90d
- `apps/settings/src/pages/BusinessUnitPage/component/GlBreakTablePanel.tsx` — 1 bug fix, last fix 3 days ago; 3 commits/90d
- `tools/integration/src/custom-fetch.integration.test.ts` — 1 bug fix, last fix 3 days ago; 4 commits/90d
- `apps/settings/src/pages/ZonePostalCodePage/component/ZonePostalCodeHeader.tsx` — 1 bug fix, last fix 3 days ago; 4 commits/90d

### Code health
Three co-equal signals: code health 7.76/10 avg (Good), hotspot health 5.61/10 (stable), worst `apps/settings/src/App.stories.tsx` at 1.0/10 · maintainability 8.56/10 · performance risk 2 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `tools/integration/src/setup-catalog.integration.test.ts` — change entropy — impact −3.0
- `libs/ui/src/spike/dispatch-board/dispatch-board-spike.fixtures.ts` — change entropy — impact −3.0
- `libs/ui/src/spike/dispatch-board/DispatchBoardSpike.tsx` — change entropy — impact −3.0
- `libs/ui/src/icons/index.ts` — change entropy — impact −2.2
- `tools/module-federation/shared.ts` — untested hotspot — impact −2.0
